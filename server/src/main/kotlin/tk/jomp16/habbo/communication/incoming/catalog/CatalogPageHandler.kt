...
class CatalogPageHandler {
    ...
    fun handle(habboSession: HabboSession, habboRequest: HabboRequest) {
        ...
        if (habboSession.userInformation.rank < catalogPage.minRank ||
                catalogPage.clubOnly && (!habboSession.userInformation.vip || !habboSession.habboSubscription.validUserSubscription)) {
            return
        }
