...
class UserInfoHandler {
    ...
    fun handle(habboSession: HabboSession, habboRequest: HabboRequest) {
        ...
        queuedHabboResponse += Outgoing.USER_PERKS to arrayOf(arrayOf(
                Triple("USE_GUIDE_TOOL", "", false),
                Triple("GIVE_GUIDE_TOURS", "", false),
                Triple("JUDGE_CHAT_REVIEWS", "", true),
                Triple("VOTE_IN_COMPETITIONS", "", true),
                Triple("CALL_ON_HELPERS", "", false),
                Triple("CITIZEN", "", true),
                Triple("TRADE", "", true),
                Triple("HEIGHTMAP_EDITOR_BETA", "", false),
                Triple("EXPERIMENTAL_CHAT_BETA", "", true),
                Triple("EXPERIMENTAL_TOOLBAR", "", true),
                Triple("BUILDER_AT_WORK", "", true),
                Triple("CAMERA", "", true),
