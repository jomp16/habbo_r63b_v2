...
class RoomItemUseClothingHandler {
    ...
    fun handle(habboSession: HabboSession, habboRequest: HabboRequest) {
        ...
        if (habboSession.userInformation.clothings.contains(roomItem.itemName)) {
            habboSession.sendSuperNotification(MiscSuperNotificationResponse.MiscSuperNotificationKeys.FIGURESET_OWNED_ALREADY)
        ...
        habboSession.sendSuperNotification(MiscSuperNotificationResponse.MiscSuperNotificationKeys.FIGURESET_REDEEMED)
